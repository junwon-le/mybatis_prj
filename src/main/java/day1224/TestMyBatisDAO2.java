...
public class TestMyBatisDAO2 {
	...
	public void updateNonParameter() throws PersistenceException {
		...
		//3. 실행결과를 받고
		System.out.println(cnt+"건 변경 되었다능!!");
	...
	public void deleteNonParameter() throws PersistenceException{
		...
		System.out.println(cnt + "건 삭제되었다능");
	...
	public static void main(String[] args) {
		...
		try {
			...
			//dataType이 없는 update / 단일형 update
			/*
			 * new TestMyBatisDAO2().updateNonParameter(); 
			 * new TestMyBatisDAO2().updateParameter(64); 
			 * 
			 */
			...
			*/
			...
			//dataType이 없는 delete // 단일형(Wrapper class) delete
