...
/**
 * MyBatis Framwork에서 조회되는 레코드가 있을 때
 * 1. 기본 생성자로 생성해주고 
...
public class EmpDomain {
	...
	public String getEname() {
		System.out.println("JSP EL에서 ${ename}으로 사용");
		return ename;
	}
	...
	public int getSal() {
		System.out.println("JSP EL에서 ${sal}으로 사용");
		return sal;
	}
	...
	public int getComm() {
		System.out.println("JSP EL에서 ${comm}으로 사용");
		return comm;
	}
	...
	public Date getHiredate() {
		System.out.println("JSP EL에서 ${hiredate}으로 사용");
		return hiredate;
	}
